...
public class NormProcessor extends AbstractActionPipelineProcessor {
    ...
    public void initialise() throws ActionLifecycleException {
    	...
    	try {
			...
			String xml = "<MESSAGE type=\"connect\" sender=\"" + handle + "\"></MESSAGE>";
    ...
    public Message process(final Message message) throws ActionProcessingException {
    	...
    	try {
			...
			System.out.println("NORM OUT: " + msg);
    	} catch (Exception e) {
    ...
    public void destroy() throws ActionLifecycleException {
        // Cleanup resources...
    	if (transmit("<MESSAGE type=\"disconnect\" sender=\"" + handle + "\"></MESSAGE>")) {
    		session.stopSender();
    ...
    private boolean transmit(String message) {
    	...
    	System.out.println("NORM OUT MSG: " + baos.toString());
    	int msgLeft = packetLength - stream.write(baos.toByteArray(), 0, packetLength);
    	if(msgLeft > 0) {
